...
namespace Bluethinkinc\LowStockNotification\Block\System\Config;
...
class SendNotificationButton extends Field
{
     ...
     * @var _template
     */
    protected $_template = 'Bluethinkinc_LowStockNotification::system/config/send_notification_button.phtml';
    /**
    ...
    {
        return $this->getUrl('admin-low-stock-notification/notification/updateadminlowstock');
    }
    /**
     * Get Button Html
     *

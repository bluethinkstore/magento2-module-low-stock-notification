...
use Bluethinkinc\LowStockNotification\Helper\Email;
use Magento\Config\Model\ResourceModel\Config\Data\CollectionFactory as Config;

class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    public const NOTIFY_ENABLE_DISABLE ='bluethink_admin_low_stock_notification/general/enable';
    /**
    ...
    */
    ...
    {
        $configValue=[];
        $configpath='bluethink_admin_low_stock_notification/'.$pathVariable;
        $storeid='0';
        $scope='default';
    ...
    /**
     * This is low stock notification
     *
     * @return synclowstocknotification
     */
    public function synclowstocknotification()
    {
        ...
        if ($notifyenabledisable==1) {
            ...
            $message=__(
                'Low stock notification has been Sent to store Owner.
